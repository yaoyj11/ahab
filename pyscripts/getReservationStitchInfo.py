...
mandatories = ['sliceID', 'reservation']
...
credentials = []
reservations = [ options.reservation ]
...
print "Querying ORCA xml-rpc server for reservation stitching information ... \n"
result = server.orca.getReservationSliceStitchInfo(options.sliceID, reservations, credentials)
print result
